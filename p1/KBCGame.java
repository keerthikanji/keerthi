package p1;
	...
	public class KBCGame {
		...
		public KBCGame(String[] simpleQuestions, String[][] simpleOptions, int[] simpleAnswer,
				String[] difficultQuestions, String[][] difficultOptions, int[] difficultAnswer,
				String[] vDifficultQuestions, String[][] vDifficultOptions, int[] vDifficultAnswer,
				Set<Integer> allIndex, int[] amount, int winningAmount) {
			super();
			...
			this.difficultOptions = difficultOptions;
			this.difficultAnswer = difficultAnswer;
			this.vDifficultQuestions = vDifficultQuestions;
			this.vDifficultOptions = vDifficultOptions;
			this.vDifficultAnswer = vDifficultAnswer;
