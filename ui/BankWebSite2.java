...
public void depositAmount() 
	...
	
	{
		...
		boolean foundOwnerAccount1 = false;
		
		for(int i = 0;i< noOfAccountEntry ;i++)
		{
			Account a = allAccounts[i];
			if(a.getAccountNumber() == accNumber1)
			{
				Account = a;
				foundOwnerAccount1 = true;
			}
			
			if(foundOwnerAccount1)
			{
...
{
	 System.out.println("\n ======== withdrawl Amount Use Case ==============\n");
	System.out.println(" Enter Account Number in which should withdrawl: ");
	int accNumber1 = sc.nextInt();
	...
	if(foundOwnerAccount1)
		{
		System.out.println(" Successfully Amount is withdrawl ");
		System.out.println(" Cheack Balance ");
		System.out.println(Account.getAccountNumber()+" - "+Account.getBalance());
